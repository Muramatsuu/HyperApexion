...
#[derive(Debug)]
pub struct HyperApexionProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HyperApexionProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HyperApexion processing");
    
    let mut processor = HyperApexionProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HyperApexionProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HyperApexionProcessor::new(false);
